                ...
                <div class="image thumbnail wrapper">
                    <div class="float_right text_right">
                        ...
                        <?php if( !empty( $this->data['Podcast']['image'] ) ) : ?>
                            ...
                            <a class="button delete" href="/podcasts/delete_image/image/<?php echo $this->data['Podcast']['id']; ?>" title="delete collection image" onclick="return confirm('Are you sure you wish to delete the Collection image?')"><span>Delete</span></a>
                        <?php endif; ?>
                    </div>
