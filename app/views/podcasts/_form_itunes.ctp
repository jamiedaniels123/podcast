<fieldset>
    ...
    <div class="clear"></div>
    <div class="itunes_container" style="display:none">
        <div class="input text">
            ...
            <input type="text" id="PodcastPublishItunesDate" value="<?php echo (int)$this->data['Podcast']['publish_itunes_date'] ? $this->data['Podcast']['publish_itunes_date'] : ''; ?>" class="datepicker hasDatepicker" name="data[Podcast][publish_itunes_date]">
        ...
        <div class="input text">
            ...
            <input type="text" id="PodcastProductionDate" value="<?php echo (int)$this->data['Podcast']['production_date'] ? $this->data['Podcast']['production_date'] : ''; ?>" class="datepicker hasDatepicker" name="data[Podcast][production_date]">
        ...
        <div class="input text">
            <label for="PodcastGrouping">Unique ID</label>
            <input type="hidden" value="" id="PodcastGrouping_" name="data[Podcast][grouping]">
            <input type="text" id="PodcastGrouping" name="data[Podcast][grouping]" value="<?php echo $this->data['Podcast']['grouping']; ?>">
            <?php echo $this->Form->error('Podcast.grouping'); ?>
        </div>
        <div class="input radio">
            <input type="hidden" value="" id="PodcastItunesuSite_" name="data[Podcast][itunesu_site]">
            <input type="radio" value="public" id="PodcastItunesuSitePublic" <?php echo $this->data['Podcast']['itunesu_site'] == 'public' ? 'checked="checked"' : '';?> name="data[Podcast][itunesu_site]">
            <label for="PodcastItunesuSitePublic">public</label>
            <input type="radio" value="private" id="PodcastItunesuSitePrivate" <?php echo $this->data['Podcast']['itunesu_site'] == 'private' ? 'checked="checked"' : '';?> name="data[Podcast][itunesu_site]">
            <label for="PodcastItunesuSitePrivate">private</label>
        </div>
        <div class="wrapper">
        ...
        <div class="clear"></div>
        <div class="input text">
            <label for="PodcastSubtitle">Subtitle</label>
            <input type="text" id="PodcastSubtitle" value="<?php echo $this->data['Podcast']['subtitle']; ?>" name="data[Podcast][subtitle]">
            <?php echo $this->Form->error('Podcast.subtitle'); ?>
        </div>
        <div class="input text">
        ...
        <div class="input file">
            <label for="PodcastImageLogoless">Logo-less image</label>
