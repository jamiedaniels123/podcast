...
<form action="" method="post" id="PodcastFilter">
    ...
    <div class="input-filter text">
        ...
        <button style="border:0;"<?php //Style on button overrides an ie issue where border will not switch off ?> id="filter_button" type="submit" class="button white" ><img src="/img/icon-16-link.png" alt="Search" width="16" height="16" class="icon" />Search</button>
    </div>
