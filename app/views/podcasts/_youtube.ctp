   ...
   <ul class="youtube">
		...
		<?php elseif( $this->Permission->isYoutubeUser() ) : ?>
				...
				<?php elseif( $this->Object->considerForYoutube( $this->data['Podcast'] ) && $this->Object->intendedForYoutube( $this->data['Podcast'] ) == false ) : ?>			
					...
					<li><a class="button orange" href="/youtube/podcasts/reject/<?php echo $this->data['Podcast']['id']; ?>" id="PodcastYoutubeReject" onclick="return confirm('You are about to reject this collection. Are you sure?');">Reject</a></li>
						
				<?php endif; ?>

				<?php if( $this->Object->intendedForYoutube( $this->data['Podcast'] ) ) : ?>
				
					<li><a class="button light-blue" href="/youtube/podcasts/reject/<?php echo $this->data['Podcast']['id']; ?>" id="PodcastYoutubeReject" onclick="return confirm('You are about to set this collection as being removed from Youtube. Are you sure?');">Unapprove</a></li>

					<?php if( $this->Object->youtubePublished( $this->data['Podcast'] ) == false ) : ?>			
                
                            <li><a class="button white" href="/youtube/podcasts/publish/<?php echo $this->data['Podcast']['id']; ?>" id="PodcastYoutubePublish" onclick="return confirm('You are about to set this collection as published on Youtube. Are you sure?');">Set as Published</a></li>
                        
                    <?php elseif( $this->Object->youtubePublished( $this->data['Podcast'] ) ) : ?>				
                        
                            <li><a class="button white" href="/youtube/podcasts/unpublish/<?php echo $this->data['Podcast']['id']; ?>" id="PodcastYoutubePublish" onclick="return confirm('You are about to set this collection as published on Youtube. Are you sure?');">Set as Unpublished</a></li>
