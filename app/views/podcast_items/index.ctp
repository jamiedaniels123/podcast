	        ...
	        <?php foreach( $this->data['PodcastItems'] as $podcast_item ) : ?>
	        	...
	        	<?php if( $this->Object->isDeleted( $podcast_item['PodcastItem'] ) == false ) : ?>
		        	...
		        	<tr>
		                ...
		                <td  class="collection-title"><a href="/podcast_items/edit/<?php echo $podcast_item['PodcastItem']['id']; ?>"><?php echo strlen( $podcast_item['PodcastItem']['title'] ) ? $podcast_item['PodcastItem']['title'] : 'Untitled '.MEDIA; ?></a></td>
