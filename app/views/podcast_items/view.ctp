<fieldset>
    ...
    <div class="clear"></div>    
    <?php $embedstring="<iframe src=\"".DEFAULT_MEDIA_URL."player/embed/pod/".$this->data['Podcast']['custom_id']."/".$this->data['PodcastItem']['shortcode'] . "?theme=basic\" scrollbars=\"none\" height=\"320\" width=\"480\"></iframe>"; ?>
