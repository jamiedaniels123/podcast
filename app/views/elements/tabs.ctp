...
<div class="tab-zone">
    <div class="tabs">
		 <?php if( $this->Permission->isAdminRouting( $this->params ) ) : ?>
             ...
             <div id="sharing"><a href="/admin/podcasts/edit/<?php echo $podcast['id']; ?>/sharing#sharing"><span class="collection_tab_track-icon">Sharing &amp; Ownership</span></a>
             </div><!--YouTube-->
             
             <div id="tracks"><a href="/admin/podcast_items/index/<?php echo $podcast['id']; ?>#tracks"><span class="collection_tab_track-icon">Tracks</span></a>
             </div><!--Tracks-->
